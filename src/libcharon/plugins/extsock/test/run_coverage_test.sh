...
declare -A COVERAGE_TESTS=(
    ...
    ["config_usecase_real"]="unit/test_config_usecase_real.c:../common/extsock_errors.c:../usecases/extsock_config_usecase.c:../adapters/strongswan/extsock_strongswan_adapter.c"
