...
struct extsock_command_handler_t {
     ...
     */
    extsock_error_t (*handle_command)(extsock_config_usecase_t *this,
                                     const char *command);
     ...
     * @return              성공 시 EXTSOCK_SUCCESS
     */
    extsock_error_t (*handle_config_command)(extsock_config_usecase_t *this,
     ...
     * @return              성공 시 EXTSOCK_SUCCESS
     */
    extsock_error_t (*handle_dpd_command)(extsock_config_usecase_t *this,
